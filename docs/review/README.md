...
**普通意见征集已开放；正式评审尚未开放。** 各入口与当前成果统一说明见 [当前进展与参与入口](../project-status.md)；初次参与可从 [三道题入门](../start-here.md) 开始。
...
截至 2026-09-06，公开仓库的 Issue 入口尚未提供“专家评审参与意向”和“劳动者评审参与意向”专用模板。希望表达参与意向的读者可以在 Discussions 提交不含联系方式或核验材料的简短说明；这仍按普通公开意见处理，不构成正式申请、资格核验、录用、正式参与、支持或背书。
